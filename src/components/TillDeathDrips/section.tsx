            ...
            <section className="relative m-5">
                <div className="container mx-auto px-4 py-8">
                    <div className="md:grid md:grid-cols-3 md:gap-8">
                        ...
                        <div className={`md:col-span-1 relative mb-8 md:mb-0 h-full ${isMobile ? 'hidden' : ''}`} >
                        ...
                        <div className="md:col-span-2">
                            ...
                            >
                                ...
                                <div className="min-w-full md:min-w-0 snap-start rounded-3xl border border-gray-100 shadow-sm border-none">
                                    ...
                                    <div className="p-4">
                                        <div className="text-sm uppercase tracking-wider text-gray-500 mb-1" onMouseEnter={() => setIsThreeHovered(true)} onMouseLeave={() => setIsThreeHovered(false)}><TextUnderline isNavLinkHovered={isThreeHovered} className={'text-gray-500'}>FLOWERS & SAINTS</TextUnderline></div>
                                        <h2 className="font-medium mb-1 text-xl" onMouseEnter={() => setIstwoHovered(true)} onMouseLeave={() => setIstwoHovered(false)}><TextUnderline isNavLinkHovered={istwoHovered}>Till Death Drips Hot - Bottle</TextUnderline></h2>
                                ...
                                <div className="min-w-full md:min-w-0 snap-start rounded-3xl border border-gray-100 shadow-sm border-none">
                                    ...
                                    <div className="p-4">
                                        <div className="text-sm uppercase tracking-wider text-gray-500 mb-1" onMouseEnter={() => setIsNavLinkHovered(true)} onMouseLeave={() => setIsNavLinkHovered(false)}>
                                            <TextUnderline isNavLinkHovered={isNavLinkHovered} className={'bg-gray-500'} >FLOWERS & SAINTS</TextUnderline></div>
                                        <h2 className="font-medium mb-1 text-xl" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}><TextUnderline isNavLinkHovered={isHovered}>Till Death Drips Hot - Eco Canvas Tote Bag</TextUnderline></h2>
