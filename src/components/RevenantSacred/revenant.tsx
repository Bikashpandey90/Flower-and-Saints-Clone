        ...
        <section className="revenant-sacred-section relative w-full overflow-hidden" style={{ isolation: "isolate" }}>
            ...
            <div className={` revenant-sacred-bg absolute inset-0 w-full h-full z-0`}>
                <img
                    ...
                    alt="Background"
                    className={`${isMobile ? 'hidden' : ''} w-full h-full object-cover scale-150`}
                />
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8">
                        ...
                        <div className="w-full lg:w-2/3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                                {products.map((product) => (
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            <div className="uppercase text-base text-gray-500 mb-1" onMouseEnter={() => { setIsNavLinkHovered(true) }} onMouseLeave={() => { setIsNavLinkHovered(false) }}><TextUnderline isNavLinkHovered={isNavLinkHovered} className={'bg-gray-500'}>FLOWERS & SAINTS</TextUnderline></div>
                                            <div className="flex justify-between items-start mb-4">
                                                <h3 className="text-lg font-inter font-medium " onMouseEnter={() => { setIsHovered(true) }} onMouseLeave={() => { setIsHovered(false) }}><TextUnderline isNavLinkHovered={isHovered}>{product.name}</TextUnderline></h3>
                            ...
                            <div className="w-full mt-8">
                                <RoundedSlideButton className="w-full py-4 bg-transparent text-white backdrop-blur-lg border border-white font-inter rounded-2xl text-center font-medium justify-center before:bg-white hover:text-neutral-900">
                                    Add to cart
                                </RoundedSlideButton>
                            </div>
                        </div>
            ...
            {/* Mobile Layout */}
            <div className={`${isMobile ? "block" : "hidden"} relative bg-white/90 z-10  px-4`}>
                {/* Mobile Content */}
                <div className="max-w-md mx-auto">
                    ...
                    <div className="relative">
                        {/* <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-medium text-black">Products</h3>
