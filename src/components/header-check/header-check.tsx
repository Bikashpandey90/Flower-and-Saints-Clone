                                    ...
                                    <Button variant="ghost" size="icon">
                                        {auth.loggedInUser ? (
                                            <img
                                                ...
                                                className="h-8 w-8 rounded-full border-none object-cover"
                                            />
                                        ) : (
                                ...
                                <li key={index} className="relative group">
                                    {item.megaMenu ? (
                                        <>
                                            ...
                                            {activeMegaMenu === item.id && item.subcategories && (
                                                <div
                                                ...
                                                >
                                                    <div className="grid grid-cols-4 gap-6">
                                                        {item.subcategories.map((subcat) => (
                                                            <div key={subcat.id}>
                                                                <h3 className="font-bold mb-3">{subcat.name}</h3>
                                                                <ul className="space-y-2">
                                                                    {subcat.items.map((subitem, idx) => (
                                                                        <li key={idx}>
                                                                            <NavLink to={subitem.to} className="text-muted-foreground hover:text-primary">
                                                                                {subitem.name}
                                                                            </NavLink>
                                                                        </li>
                                                                    ))}
                                                            ...
                                                            <div className="row-span-2">
                                                                <div className="relative h-full min-h-[200px] rounded-lg overflow-hidden">
                                                                    ...
                                                                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4">
                                                                        <h3 className="text-white font-bold mb-2">{item.featured.title}</h3>
                                                                        <Button size="sm" variant="secondary" asChild>
                                                                            <NavLink to={item.featured.link}>Shop Now</NavLink>
                                                                        </Button>
                                                                    </div>
                                                                </div>
                                                            </div>
