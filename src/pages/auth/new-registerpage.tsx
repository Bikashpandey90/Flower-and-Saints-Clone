...
export default function NewRegisterPage() {
    return (
        <div className="min-h-screen  flex items-center justify-center px-4">
            <div className="w-full max-w-md bg-gray-100 rounded-3xl p-10 pt-24 pb-16 space-y-8 m-10">
                {/* Logo */}
                ...
                <div className="space-y-5">
                    <div className="text-start space-y-2">
                        <h2 className="text-xl  font-inter font-thin  text-black">Create an account</h2>
                        <p className="text-md font-inter text-gray-600">Choose how you'd like to sign up</p>
                    </div>
