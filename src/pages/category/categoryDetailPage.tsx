...
export default function CategoryDetailsPage() {
  ...
  const [detail, setDetail] = useState<Category | null>(null) // Define state properly
  ...
  if (!detail) return <p>Category not found</p> // Handle null case
  ...
  return (
    ...
    >
      <Button variant="outline" onClick={() => navigate(-1)} className="mb-6">
        <ArrowLeft className="mr-2 h-4 w-4" /> Back to Categorys
      </Button>
